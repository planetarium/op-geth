...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.OverrideOptimismLibplanet = c.OverrideOptimismLibplanet
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.OverrideOptimismLibplanet != nil {
		c.OverrideOptimismLibplanet = dec.OverrideOptimismLibplanet
	}
